<div class="toplogin">
  <div class="options"><a id="login_html" data-tr="LOG IN">LOG IN</a>&nbsp;&nbsp;&nbsp;<a id="register_html" data-tr="REGISTER">REGISTER</a> <br><br><a id="cart" href="<?php amigable('?module=cart&function=list_cart'); ?>">Cart</a></div>
  <div class="language">
    <form>
